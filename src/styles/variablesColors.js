...
const variablesColors = css`
    :root {
        --primary             : #4945ff;
        --primary-rgb         : 73, 68, 254;
        --primary-dark        : #3933FE;
        --primary-dark-rgb    : 57, 51, 254;
        --primary-light       : #7b79ff;
        --primary-light-rgb   : 123, 121, 255;

        --secondary      : #ff8a65;
        --secondary-rgb  : 255, 138, 101;
        --secondary-dark : #c7856d;
        ...
        --success-color : rgb(204, 232, 205);
        --info          : #0dcaf0;
        --info-rgb      : 13,  202, 240;
        --info-color    : rgb(184, 231, 251);
        --warning       : #ffc107;
        --warning-rgb   : 255, 193, 7;
        --warning-color : rgb(255, 226, 183);
        --danger        : #dc3545;
        --danger-rgb    : 220, 53,  69;
        --danger-color  : rgb(244, 199, 199);
